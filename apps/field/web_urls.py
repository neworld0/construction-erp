...
from .daily_report_views import field_project_daily_report_detail, field_project_daily_report_list, field_project_daily_report_pdf

urlpatterns = [
    path("", field_dashboard),
    path("approved/", field_approved_list),
    path("site-daily-logs/", field_project_daily_report_list),
    path("site-daily-logs/projects/<int:project_id>/", field_project_daily_report_detail),
    path("site-daily-logs/projects/<int:project_id>/print.pdf", field_project_daily_report_pdf),
    ...
    path("progress/<int:progress_id>/correction/", field_progress_correction_new),
